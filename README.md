...
В нашем распоряжении имеются данные об оттоке клиентов некоторого банка. Задачей банка является разработка компании лояльности для удержания клиентов, и для этого ему необходимо выявить факторы связанные с оттком клиентов. Сделать это проще всего сравнив профили клиентов покинувших банк с профилями клиентов сохранивших свою лояльность, а также выявить взаимосвязь признаков определяющих поведение клиентов. После проведения разведовательного внализа, банк сможет отобрать признаки которые статистически значимо вдлияют на решение клиента, и построить на их осннове модель машинного обучения, способную прогнозировать уход клиента.
